...
| Admin ops audit log           | `/api/admin/ops/audit-log`                    | GET JSON (`generatedAt`, `source`, `truncated`, `entries[]`)                                                                            | journal canonique des actions sensibles admin ops (imports, s̩curit̩)                          |

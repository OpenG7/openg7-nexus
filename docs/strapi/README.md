...
This folder centralizes technical notes, migrations, and operating conventions for the official `strapi` workspace.

- `workspaces.md` - workspace overview, responsibilities, and day-to-day operations.
...
- `admin-quality-matrix-sync.md` - secrets, workflow wiring, rotation, and diagnostics for the post-merge matrix refresh signal.
